...
export default function MyOrdersPage() {
        ...
        setTimeout(() => {
            const mockOrders = [
                ...
                },
                {
                    _id: 56789,
                    createdAt: new Date(),
                    shippingAddress: { city: "Washington", country: "USA" },
                    orderItems: [
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 sm:p-6 mt-20 mb-3">
            <h2 className="text-xl sm:text-2xl font-bold mb-6">My Orders</h2>
            <div className="relative shadow-md sm:rounded-lg overflow-x-auto">
                <table className="min-w-full text-left text-gray-500">
                    <thead className="bg-gray-100 text-xs uppercase text-gray-700">
                        <tr>
                            <th className="py-2 sm:py-3 px-4">Image</th>
                            <th className="py-2 sm:py-3 px-4">Order ID</th>
                            <th className="py-2 sm:py-3 px-4">Created</th>
                            <th className="py-2 sm:py-3 px-4">Shipping Address</th>
                            <th className="py-2 sm:py-3 px-4">Items</th>
                            <th className="py-2 sm:py-3 px-4">Price</th>
